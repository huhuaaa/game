define('webpack/lib/node/NodeMainTemplatePlugin', function(require, exports, module) {
  ...
  NodeMainTemplatePlugin.prototype.apply = function (mainTemplate) {
  	...
  	mainTemplate.plugin("require-ensure", function (_, chunk, hash) {
  		...
  		if (self.asyncChunkLoading) {
  			return this.asString(["if(installedChunks[chunkId] === 1) callback.call(null, " + this.requireFn + ");", "else if(!installedChunks[chunkId]) {", this.indent(["installedChunks[chunkId] = [callback];", "var filename = "/node_modules/webpack/lib/node" + " + this.applyPluginsWaterfall("asset-path", JSON.stringify("/" + chunkFilename), {
  	...
  	mainTemplate.plugin("hot-bootstrap", function (source, chunk, hash) {
  		...
  		return Template.getFunctionContent(self.asyncChunkLoading ? require("webpack/lib/node/NodeMainTemplateAsync.runtime") : require("webpack/lib/node/NodeMainTemplate.runtime")).replace(/\$require\$/g, this.requireFn).replace(/\$hotMainFilename\$/g, currentHotUpdateMainFilename).replace(/\$hotChunkFilename\$/g, currentHotUpdateChunkFilename);
  	});
