define('webpack/lib/NodeStuffPlugin', function(require, exports, module) {
  ...
  */
  ...
  NodeStuffPlugin.prototype.apply = function (compiler) {
  	...
  	if (this.options."/node_modules/webpack/lib/NodeStuffPlugin.js" === "mock") {
  		setConstant(""/node_modules/webpack/lib/NodeStuffPlugin.js"", "/index.js");
  	} else if (this.options."/node_modules/webpack/lib/NodeStuffPlugin.js") {
  		setModuleConstant(""/node_modules/webpack/lib/NodeStuffPlugin.js"", function (module) {
  			return path.relative(context, module.resource);
  		});
  	}
  	compiler.parser.plugin("evaluate Identifier "/node_modules/webpack/lib/NodeStuffPlugin.js"", function (expr) {
  	...
  	if (this.options."/node_modules/webpack/lib" === "mock") {
  		setConstant(""/node_modules/webpack/lib"", "/");
  	} else if (this.options."/node_modules/webpack/lib") {
  		setModuleConstant(""/node_modules/webpack/lib"", function (module) {
  			return path.relative(context, module.context);
  		});
  	}
  	compiler.parser.plugin("evaluate Identifier "/node_modules/webpack/lib"", function (expr) {
  		if (!this.state.module) return;
  		var res = new BasicEvaluatedExpression();
  	...
  	compiler.parser.plugin("expression module", function () {
  		var moduleJsPath = path.join("/node_modules/webpack/lib", "..", "buildin", "module.js");
