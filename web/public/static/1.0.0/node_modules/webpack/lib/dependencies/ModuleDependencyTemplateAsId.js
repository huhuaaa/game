define('webpack/lib/dependencies/ModuleDependencyTemplateAsId', function(require, exports, module) {
  ...
  */
  ...
  ModuleDependencyTemplateAsId.prototype.apply = function (dep, source, outputOptions, requestShortener) {
  	...
  	if (dep.module) var content = comment + JSON.stringify(dep.module.id);else var content = require("webpack/lib/dependencies/WebpackMissingModule").module(dep.request);
