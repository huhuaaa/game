define('webpack/lib/dependencies/AMDRequireArrayDependency', function(require, exports, module) {
  ...
  AMDRequireArrayDependency.Template.prototype.apply = function (dep, source, outputOptions, requestShortener) {
  	var content = "[" + dep.depsArray.map(function (dep) {
  		if (typeof dep === "string") {
  			...
  			if (dep.module) return "__webpack_require__(" + comment + JSON.stringify(dep.module.id) + ")";else return require("webpack/lib/dependencies/WebpackMissingModule").module(dep.request);
  		}
  	}).join(", ") + "]";
