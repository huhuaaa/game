define('webpack/lib/dependencies/ModuleDependencyTemplateAsRequireId', function(require, exports, module) {
  ...
  */
  ...
  ModuleDependencyTemplateAsRequireId.prototype.apply = function (dep, source, outputOptions, requestShortener) {
  	...
  	if (dep.module) var content = "__webpack_require__(" + comment + JSON.stringify(dep.module.id) + ")";else var content = require("webpack/lib/dependencies/WebpackMissingModule").module(dep.request);
