define('webpack/lib/dependencies/AMDRequireDependenciesBlockParserPlugin', function(require, exports, module) {
  				...
  				try {
  					...
  					if (fnData) {
  						this.inScope(fnData.fn.params.filter(function (i) {
  							...
  							if (fnData.fn.body.type === "BlockStatement") this.walkStatement(fnData.fn.body);else this.walkExpression(fnData.fn.body);
  						}).bind(this));
