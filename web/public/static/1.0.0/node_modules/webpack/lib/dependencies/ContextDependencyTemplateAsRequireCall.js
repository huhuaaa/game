define('webpack/lib/dependencies/ContextDependencyTemplateAsRequireCall', function(require, exports, module) {
  ...
  */
  ...
  ContextDependencyTemplateAsRequireCall.prototype.apply = function (dep, source, outputOptions, requestShortener) {
  	...
  	if (dep.module && dep.module.dependencies && dep.module.dependencies.length > 0) {
  		...
  		var content = require("webpack/lib/dependencies/WebpackMissingModule").module(dep.request);
