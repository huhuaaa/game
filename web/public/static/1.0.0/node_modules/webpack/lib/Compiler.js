define('webpack/lib/Compiler', function(require, exports, module) {
  ...
  */
  ...
  var Resolver = require("webpack/node_modules/enhanced-resolve/lib/Resolver");
  
  var NormalModuleFactory = require("webpack/lib/NormalModuleFactory");
  var ContextModuleFactory = require("webpack/lib/ContextModuleFactory");
  ...
  Compiler.prototype.emitAssets = function (compilation, callback) {
  	...
  	function emitFiles(err) {
  		...
  		require("webpack/node_modules/async/lib/async").forEach(Object.keys(compilation.assets), (function (file, callback) {
