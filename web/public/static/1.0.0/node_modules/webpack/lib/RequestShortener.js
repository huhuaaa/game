define('webpack/lib/RequestShortener', function(require, exports, module) {
  ...
  */
  ...
  function RequestShortener(directory) {
  	...
  	if ("/node_modules/webpack/lib".length >= 2) {
  		var buildins = path.join("/node_modules/webpack/lib", "..").replace(/\\/g, "/");
