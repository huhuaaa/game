define('webpack/lib/LibraryTemplatePlugin', function(require, exports, module) {
  ...
  */
  ...
  var SetVarMainTemplatePlugin = require("webpack/lib/SetVarMainTemplatePlugin");
  	...
  	compiler.plugin("this-compilation", (function (compilation) {
  		switch (this.target) {
  			...
  			case "commonjs2":
  				...
  				break;
  			case "amd":
  				var AmdMainTemplatePlugin = require("webpack/lib/AmdMainTemplatePlugin");
  				compilation.apply(new AmdMainTemplatePlugin(this.name));
  				break;
  			case "umd":
  			case "umd2":
  				var UmdMainTemplatePlugin = require("webpack/lib/UmdMainTemplatePlugin");
  				...
  				break;
  			case "jsonp":
  				var JsonpExportMainTemplatePlugin = require("webpack/lib/JsonpExportMainTemplatePlugin");
