define('webpack/lib/HotModuleReplacementPlugin', function(require, exports, module) {
  ...
  */
  ...
  var ModuleHotAcceptDependency = require("webpack/lib/dependencies/ModuleHotAcceptDependency");
  var ModuleHotDeclineDependency = require("webpack/lib/dependencies/ModuleHotDeclineDependency");
  ...
  var hotInitCode = Template.getFunctionContent(require("webpack/lib/HotModuleReplacement.runtime"));
