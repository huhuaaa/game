define('html-webpack-plugin/node_modules/pretty-error/node_modules/renderkid/node_modules/htmlparser2/node_modules/domutils/index', function(require, exports, module) {

  "use strict";
  
  var ElementType = require("html-webpack-plugin/node_modules/pretty-error/node_modules/renderkid/node_modules/htmlparser2/node_modules/domelementtype/index"),
  ...
  DomUtils.getElements = function (options, element, recurse, limit) {
  	...
  	for (var key in options) {
  		if (options.hasOwnProperty(key)) {
  			if (key in Checks) funcs.push(Checks[key](options[key]));else funcs.push(getAttribCheck(key, options[key]));
  		}
  	}
  ...
  DomUtils.getText = function getText(_x) {
  	var _again = true;
