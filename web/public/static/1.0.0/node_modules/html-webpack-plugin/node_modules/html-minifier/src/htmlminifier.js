define('html-webpack-plugin/node_modules/html-minifier/src/htmlminifier', function(require, exports, module) {

  'use strict';
  
  var CleanCSS = require('html-webpack-plugin/node_modules/html-minifier/node_modules/clean-css/index');
  var decode = require('html-webpack-plugin/node_modules/html-minifier/node_modules/he/he').decode;
  var HTMLParser = require('html-webpack-plugin/node_modules/html-minifier/src/htmlparser').HTMLParser;
  var RelateUrl = require('html-webpack-plugin/node_modules/html-minifier/node_modules/relateurl/lib/index');
  var TokenChain = require('html-webpack-plugin/node_modules/html-minifier/src/tokenchain');
  var UglifyJS = require('webpack/node_modules/uglify-js/tools/node');
  var utils = require('html-webpack-plugin/node_modules/html-minifier/src/utils');
  ...
  function buildAttr(normalized, hasUnarySlash, options, isLast) {
    ...
    if (typeof attrValue !== 'undefined' && !options.removeAttributeQuotes || !canRemoveAttributeQuotes(attrValue)) {
  ...
  function processOptions(options) {
    ...
    if (!('ignoreCustomFragments' in options)) {
      options.ignoreCustomFragments = [/<%[\s\S]*?%>/, /<\?[\s\S]*?\?>/];
    }
  ...
  function minify(value, options, partialMarkup) {
    ...
    new HTMLParser(value, {
      ...
      doctype: function doctype(_doctype) {
        buffer.push(options.useShortDoctype ? '<!DOCTYPE html>' : collapseWhitespaceAll(_doctype));
      },
