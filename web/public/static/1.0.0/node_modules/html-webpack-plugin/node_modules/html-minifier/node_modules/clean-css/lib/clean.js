define('html-webpack-plugin/node_modules/html-minifier/node_modules/clean-css/lib/clean', function(require, exports, module) {
  ...
  var ImportInliner = require('html-webpack-plugin/node_modules/html-minifier/node_modules/clean-css/lib/imports/inliner');
  var rebaseUrls = require('html-webpack-plugin/node_modules/html-minifier/node_modules/clean-css/lib/urls/rebase');
  
  var tokenize = require('html-webpack-plugin/node_modules/html-minifier/node_modules/clean-css/lib/tokenizer/tokenize');
  var simpleOptimize = require('html-webpack-plugin/node_modules/html-minifier/node_modules/clean-css/lib/selectors/simple');
  var advancedOptimize = require('html-webpack-plugin/node_modules/html-minifier/node_modules/clean-css/lib/selectors/advanced');
  
  var simpleStringify = require('html-webpack-plugin/node_modules/html-minifier/node_modules/clean-css/lib/stringifier/simple');
  var sourceMapStringify = require('html-webpack-plugin/node_modules/html-minifier/node_modules/clean-css/lib/stringifier/source-maps');
  
  var CommentsProcessor = require('html-webpack-plugin/node_modules/html-minifier/node_modules/clean-css/lib/text/comments-processor');
  var ExpressionsProcessor = require('html-webpack-plugin/node_modules/html-minifier/node_modules/clean-css/lib/text/expressions-processor');
  var FreeTextProcessor = require('html-webpack-plugin/node_modules/html-minifier/node_modules/clean-css/lib/text/free-text-processor');
  var UrlsProcessor = require('html-webpack-plugin/node_modules/html-minifier/node_modules/clean-css/lib/text/urls-processor');
  
  var Compatibility = require('html-webpack-plugin/node_modules/html-minifier/node_modules/clean-css/lib/utils/compatibility');
  var InputSourceMapTracker = require('html-webpack-plugin/node_modules/html-minifier/node_modules/clean-css/lib/utils/input-source-map-tracker');
  var SourceTracker = require('html-webpack-plugin/node_modules/html-minifier/node_modules/clean-css/lib/utils/source-tracker');
  var SourceReader = require('html-webpack-plugin/node_modules/html-minifier/node_modules/clean-css/lib/utils/source-reader');
  var Validator = require('html-webpack-plugin/node_modules/html-minifier/node_modules/clean-css/lib/properties/validator');
  
  var fs = require('fs');
  var path = require('path');
  var url = require('webpack/node_modules/node-libs-browser/node_modules/url/url');
  
  var override = require('html-webpack-plugin/node_modules/html-minifier/node_modules/clean-css/lib/utils/object').override;
