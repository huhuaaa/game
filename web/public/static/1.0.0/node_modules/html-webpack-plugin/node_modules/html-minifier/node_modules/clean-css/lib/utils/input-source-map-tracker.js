define('html-webpack-plugin/node_modules/html-minifier/node_modules/clean-css/lib/utils/input-source-map-tracker', function(require, exports, module) {
  ...
  function originalPositionIn(_x, _x2, _x3, _x4, _x5) {
    var _again = true;
  
    _function: while (_again) {
      var trackedSource = _x,
          line = _x2,
          column = _x3,
          token = _x4,
          allowNFallbacks = _x5;
      ...
      if (originalPosition.line === null && line > 1 && allowNFallbacks > 0) {
        ...
        _x3 = column;
        _x4 = token;
        _x5 = allowNFallbacks - 1;
        _again = true;
        originalPosition = maxRange = position = undefined;
        continue _function;
      }
  ...
  InputSourceMapStore.prototype.track = function (data, whenDone) {
    return typeof this.options.sourceMap == 'string' ? fromString(this, data, whenDone) : fromSource(this, data, whenDone, { files: [], cursor: 0, errors: this.errors });
  };
