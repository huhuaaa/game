define('html-webpack-plugin/node_modules/html-minifier/node_modules/clean-css/lib/utils/source-tracker', function(require, exports, module) {
  ...
  SourceTracker.prototype.nextStart = function (data) {
    ...
    return next ? { index: next.index, filename: this.sources[~ ~next[1]] } : null;
  };
