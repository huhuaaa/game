define('extract-text-webpack-plugin/ExtractedModule', function(require, exports, module) {
  ...
  */
  ...
  var SourceMapSource = require("extract-text-webpack-plugin/node_modules/webpack-sources/lib/index").SourceMapSource;
  var RawSource = require("extract-text-webpack-plugin/node_modules/webpack-sources/lib/index").RawSource;
  ...
  ExtractedModule.prototype.source = function () {
  	if (this._sourceMap) return new SourceMapSource(this._source, null, this._sourceMap);else return new RawSource(this._source);
  };
