define('fis-parser-babel-5.x/node_modules/babel-core/node_modules/output-file-sync/node_modules/graceful-fs/graceful-fs', function(require, exports, module) {

  var process = require('webpack/node_modules/node-libs-browser/node_modules/process/browser');
  'use strict';
  
  var fs = require('fis-parser-babel-5.x/node_modules/babel-core/node_modules/output-file-sync/node_modules/graceful-fs/fs');
  var polyfills = require('fis-parser-babel-5.x/node_modules/babel-core/node_modules/output-file-sync/node_modules/graceful-fs/polyfills');
  var legacy = require('fis-parser-babel-5.x/node_modules/babel-core/node_modules/output-file-sync/node_modules/graceful-fs/legacy-streams');
  var queue = [];
  ...
  if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || '')) {
    process.on('exit', function () {
      debug(queue);
      require('webpack/node_modules/node-libs-browser/node_modules/assert/assert').equal(queue.length, 0);
    });
  }
  
  module.exports = patch(require('fis-parser-babel-5.x/node_modules/babel-core/node_modules/output-file-sync/node_modules/graceful-fs/fs'));
